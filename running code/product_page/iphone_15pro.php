...
$sql = "SELECT * FROM Apple_data WHERE model_name='iPhone 15 pro'";
$result = $conn->query($sql);
$device = $result->fetch_assoc();

// Fetch the scores data from the database
$sql = "SELECT Design, Display, Performance, Cameras, OS, Battery, Audio, Features FROM apple_data_score WHERE model_name='iphone 15 pro'";
$result = $conn->query($sql);
...
<body>
    ...
    <main class="main-content">
        ...
        <img class="intro_png" src="/techspec/product_imgs/apple/15_pro-removebg-preview.png" alt="16 Plus">
        <img class="intro_png" src="/techspec/product_imgs/apple/15pro_feature list.jpg" alt="12 Pro 5G">
        <img class="intro_png" src="/techspec/product_imgs/apple/15pro_front.jpg" alt="Galaxy A54">
         </div>
