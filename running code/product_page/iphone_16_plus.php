...
$sql = "SELECT * FROM Apple_data WHERE model_name='iPhone 16 plus'";
$result = $conn->query($sql);
$device = $result->fetch_assoc();

// Fetch the scores data from the database
$sql = "SELECT Design, Display, Performance, Cameras, OS, Battery, Audio, Features FROM apple_data_score WHERE model_name='iphone 16 plus'";
$result = $conn->query($sql);
...
<body>
    ...
    <main class="main-content">
        ...
        <img class="intro_png" src="/techspec/product_imgs/apple/16_front_back.png" alt="16 Plus">
        <img class="intro_png" src="/techspec/product_imgs/apple/16_front_back.png" alt="12 Pro 5G">
